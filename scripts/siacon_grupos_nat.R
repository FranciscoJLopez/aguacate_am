...
# En principio se extaer?an con tabulazer, pero se gener? un error
# por construcci?n de las tablas, por lo que se procedio con la copia
...
gn_cer[,4] <- stringr::str_replace(gn_cer[,4], "?", "?")
...
gn_epm[,4] <- stringr::str_replace(gn_epm[,4], "é", "?")
gn_epm[,4] <- stringr::str_replace(gn_epm[,4], "ó", "?")
gn_epm[,4] <- stringr::str_replace(gn_epm[,4], "?", "?")
...
gn_for[,4] <- stringr::str_replace(gn_for[,4], "é", "?")
gn_for[,4] <- stringr::str_replace(gn_for[,4], "ó", "?")
gn_for[,4] <- stringr::str_replace(gn_for[,4], "ú", "?")
gn_for[,4] <- stringr::str_replace(gn_for[,4], "ñ", "?")
gn_for[,4] <- stringr::str_replace(gn_for[,4], "?", "?")
...
gn_fru01[,4] <- stringr::str_replace(gn_fru01[,4], "é", "?")
gn_fru01[,4] <- stringr::str_replace(gn_fru01[,4], "á", "?")
gn_fru01[,4] <- stringr::str_replace(gn_fru01[,4], "ó", "?")
gn_fru01[,4] <- stringr::str_replace(gn_fru01[,4], "ú", "?")
gn_fru01[,4] <- stringr::str_replace(gn_fru01[,4], "ñ", "?")
gn_fru01[,4] <- stringr::str_replace(gn_fru01[,4], "?", "?")
...
gn_fru02[,4] <- stringr::str_replace(gn_fru02[,4], "é", "?")
gn_fru02[,4] <- stringr::str_replace(gn_fru02[,4], "á", "?")
gn_fru02[,4] <- stringr::str_replace(gn_fru02[,4], "ó", "?")
gn_fru02[,4] <- stringr::str_replace(gn_fru02[,4], "ú", "?")
gn_fru02[,4] <- stringr::str_replace(gn_fru02[,4], "ñ", "?")
gn_fru02[,4] <- stringr::str_replace(gn_fru02[,4], "?", "?")
...
gn_hor01[,4] <- stringr::str_replace(gn_hor01[,4], "é", "?")
gn_hor01[,4] <- stringr::str_replace(gn_hor01[,4], "á", "?")
gn_hor01[,4] <- stringr::str_replace(gn_hor01[,4], "ó", "?")
gn_hor01[,4] <- stringr::str_replace(gn_hor01[,4], "ú", "?")
gn_hor01[,4] <- stringr::str_replace(gn_hor01[,4], "ñ", "?")
gn_hor01[,4] <- stringr::str_replace(gn_hor01[,4], "?", "?")
...
gn_hor02[,4] <- stringr::str_replace(gn_hor02[,4], "é", "?")
gn_hor02[,4] <- stringr::str_replace(gn_hor02[,4], "á", "?")
gn_hor02[,4] <- stringr::str_replace(gn_hor02[,4], "ó", "?")
gn_hor02[,4] <- stringr::str_replace(gn_hor02[,4], "ú", "?")
gn_hor02[,4] <- stringr::str_replace(gn_hor02[,4], "ñ", "?")
gn_hor02[,4] <- stringr::str_replace(gn_hor02[,4], "?", "?")
...
gn <- read_csv("~/OneDrive/R/repos/aguacate_am/aux_doc/gn.txt", col_names = FALSE,
...
cultivos17 <- cultivos17 %>% left_join(select(id_cult, idcultivo, nomcultivo), by = "idcultivo")
...
# Debido a la presencia de un gran n?mero de casos NA en la variable gn
...
# se a?ade un ?ndice que permite faciltar las operaciones de filtrado
